...
void TrainMA::TrainMAFunction()
{
    ...
    std::cout << "Start printing province barracks information: \033[34m" << endl;
    std::cout << "Province of kingdom " << participantsList[provincesMap[provinceXCoordinate][provinceYCoordinate].getBelongsToParticipant()].getKingdomName() << " selected" << endl;
    std::cout << "Coordinates: (" << translateCoordinate(provinceYCoordinate, 'x', 'O') << ", " << translateCoordinate(provinceXCoordinate, 'y', 'O') << ") " << endl << endl;
    std::cout << "The barracks level of this province: " << barracksLevel << endl;
    ...
    if (trainTroop <= troopTier)
    {
        ...
        do
        {
            ...
            {
                repeatOuterDoLoop = 'Y';
                std::cout << "Amount of troops selected exceeds the training capacity of the barracks... please try again" << endl;
            }
...
{
  std::cout << "Welcome to the Player Train menu" << endl << endl;
