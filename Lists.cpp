...
char Lists::listOfActions() // print out what actions a player can do
{
  ...
  std::cout << "\033[;31m---------- List of Operations: ----------" << endl;
  switch (identifier) {
  ...
  {
    std::cout << "- Move this unit (P)" << endl;
    std::stringToSend = "P";
    break;
  }
  case 3: /*introduction*/
  {
    std::cout << "- Start a new conquest (S)" << endl;
    std::cout << "- Resume a previous conquest (R)" << endl;
    std::stringToSend = "SR";
    break;
  }
  case 4: /*playerAction*/
...
void Lists::listOfHelp() {
  std::cout << "\033[;34m ---------- Begin Help ----------" << endl;
  switch (identifier) {
  case 2: {
  ...
  case 3: {
    std::cout << "Start a new conquest (S): " << endl;
    std::cout << "- Start a new game" << endl;
    std::cout << "Resume a previous conquest (R): " << endl;
  ...
  case 4: // playerActionHelp
  {
    ...
    std::cout << "Train troops (T): " << endl;
    std::cout << "- Select one of your provinces and train troops " << endl;
    ...
    std::cout << "Go to the next turn (G): " << endl;
  ...
  case 5: {
    ...
    std::cout << "- The price of upgrading a commander increases as the level of "
         ...
         << endl;
    std::cout << "- There is no cap on how much you can upgrade a commander" << endl;
    ...
    std::cout << "View army overview (V): " << endl;
    std::cout << "- See all your armies (their coordinates and their stats)" << endl
         << endl;

    std::cout << "Deploy a commander (D): " << endl;
    std::cout << "- Move commanders out of the capital and onto the map" << endl;
    break;
  }
  case 8: {
    std::cout << "On the map, each coordinate is a province that containes a type "
         ...
         << endl
         << endl;
    std::cout << "P) Your capital province " << endl;
    std::cout << "p) One of your provinces " << endl;
    std::cout << "E) Your enemy's capital province " << endl;
    std::cout << "e) One of your eneny's provinces " << endl;
    std::cout << "H) One of your army units " << endl;
    std::cout << "V) One of your enemy's army units " << endl;
    std::cout << endl;
