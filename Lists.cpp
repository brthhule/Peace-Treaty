  ...
  case 11: /*scoutLogFunction*/
  {
    ...
    for (int x = 0; x < 3; x++) {
      std::cout << "- View the " << SLFReports << " report for this province ("
                << toupper(SLFReports[x].at(0)) << ") " << endl;
    }
    stringToSend = "GRBM";
    break;
  }
  }
  std::cout << "-------------- End List: ---------------- \033[;0m" << endl
            << endl;
...
void Lists::listOfHelp() {
  ...
  switch (identifier) {
  case 2: {
    cout << "- You can select to move one of your army units. Only army units "
            "deployed with an army commander can move (these are sent out via "
            "your capital). "
         << endl;
    cout << "- Garrisons cannot move, but they can be absorved into army units "
            "that are in the same province as an army. "
         << endl
         << endl;
    cout << "- If you move an army unit to an empty province, the army unit "
            "takes over that province without resistance. "
         << endl;
    cout << "- If you move an army unit to an enemy province, the army unit "
         ...
         << endl;
    cout << "- If you move an army unit to one of your provinces, you can "
         ...
         << endl;
    cout << endl;
    cout << "You can increase the size of an army by increasing the level of "
  ...
  case 3: {
    ...
    cout << "Resume a previous conquest (R): " << endl;
    cout << "- Enter a code/text file to import a game/generate a game with "
  ...
  case 4: // playerActionHelp
  {
    ...
    cout << "- Select one of your provincesand build or upgrade one or several "
    ...
    cout << "- The tier troop you can train depends on the level of the "
            "barracks in this province"
         << endl;
    cout << "- Your capital province automatically starts with a barracks "
    ...
    cout << "- See your overall stats, including the total amount of "
            "resourcesand troops across all your provinces "
         << endl;
    cout << "- You can see the specific stats of each of your provinces "
            "through the view map action. "
         << endl
         << endl;

    cout << "View the map (M): " << endl;
    cout << "- See a map of the continent. Help for the map is available in "
            "the map section. "
         << endl;
    cout << "- Through the map, you can see the specific stats of each of your "
            "province(such as resources and troops available in the province). "
         << endl;
    cout << "- You can also scoutand attack enemy provinces through this "
            "action. "
         << endl
         << endl;

    cout << "View army deployment (A): " << endl;
    cout << "- Train army commanders here. The amount of army commanders you "
            "can have corresponds to the size of the continent. "
         << endl;
    cout << "- Through this action, you can also see the coordinates of each "
            "of your armiesand their specific stats. "
         << endl;
    cout << "- If an army is totally defeated, its army commander will dieand "
            "a new one will have to be trained "
         << endl
         << endl;

    cout << "Go to the next turn (G): " << endl;
    cout << "- This a turn - based game.You can scout enemy provinces, train "
            "troops, view your stats, and build infrastructure as much as "
            "you'd like. "
         << endl;
    cout << "- However, you can only get new resources by going to the next "
            "turn, and each of your armies can only move once per turn. "
         << endl
         << endl;

    cout << "Pause game (P): " << endl;
    cout << "- End the game and get a code to play again at another time. "
         << endl;
    break;
  }
  case 5: {
    cout << "Train a commander (T): " << endl;
    cout << "- The price of training a commander increases as the amount of "
            "commanders you have increases. You start off with one commander"
         << endl;
    // cout << "- The max limit of commanders you can train: " <<
    // maxAmountOfCommanders << endl << endl;

    cout << "Upgrade a commander (U): " << endl;
    cout << "- The price of upgrading a commander increases as the level of "
            "the commander increases"
         << endl;
    cout << "- There is no cap on how much you can upgrade a commander" << endl;
    cout << "- The greater the level of a commander, the more troops they can "
            "lead in their army (5 units per level) "
         << endl
         << endl;

    cout << "View army overview (V): " << endl;
    cout << "- See all your armies (their coordinates and their stats)" << endl
         << endl;
  ...
  case 8: {
    cout << "On the map, each coordinate is a province that containes a type "
    ...
    cout << endl;
    cout << "If there are two letters in one province, that means that there "
         ...
         << endl
         << endl;
    cout << "Enter the x and y coordinates of the province you want to select. "
            "Depending on the type of province, you can build infrastructure, "
            "train troops, move armies, or attack armies. "
         << endl;
    cout << "------------ This is the end of the Help message ------------"
         << endl;
    break;
  }
